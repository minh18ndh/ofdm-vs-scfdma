...
At 20 dB SNR, the SC-FDMA simulation produced zero detected bit errors.
This result does not imply a mathematically perfect communication system,
but rather indicates that no bit errors were observed within the finite
simulation length of 200000 transmitted blocks.
