...
%\begin{figure}[H]
%    \centering
%    \includegraphics[width=0.88\textwidth]{Figures/cp_insertion.png}
...
%\begin{figure}[H]
%    \centering
%    \includegraphics[width=0.9\textwidth]{Figures/channel_response.png}
...
\begin{figure}[H]
    ...
    \includegraphics[width=1.2\textwidth]{Figures/ber_plot.png}
